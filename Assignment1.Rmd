...
<p>
(b) The lower left three conditional plots show individual CCATFISH data points in the rivers, FRM, LCM, and SCM. They show the length and weight of each species, and because the color is the same within the individual coplot, the fish were from the same MILE.<br><br>
(c) Line A (37) <br>
...
<br><br>
(e) The top six plots are empty due to none of the given species having data points in the given river, that is, this fish was not recorded in the river!<br><br>
(f)
</p>
...
## Question 4
<p>
(a) The four random sampling designs are <i>simple random sampling</i> (Simple), <i>stratified random sampling</i>, <i>cluster sampling</i>, and <i>systemic sampling</i> (Last three complex).<br><br>
(b) Description of sampling techniques.<br>
...
```
<p>20,000 km/s is within 1 standard deviation of cluster A's mean, therefore, it is highly likely this data point came from it.</p>
